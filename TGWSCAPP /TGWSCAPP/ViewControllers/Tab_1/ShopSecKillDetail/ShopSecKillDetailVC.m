...
@interface ShopSecKillDetailVC ()<TSVideoPlaybackDelegate,UIScrollViewDelegate>
{
    UIScrollView *scView;
...
@implementation ShopSecKillDetailVC

#pragma mark --- lifecylce
- (void)viewDidLoad {
    [super viewDidLoad];
    // Do any additional setup after loading the view.
    nav = [self layoutNaviBarViewWithTitle:@"秒杀商品详情"];
