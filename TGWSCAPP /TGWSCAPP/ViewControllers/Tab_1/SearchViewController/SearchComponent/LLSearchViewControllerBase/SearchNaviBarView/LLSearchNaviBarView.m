...
- (UIButton *)rightOneBtn
{
    if (!_rightOneBtn) {
        ...
        _rightOneBtn = ({
            ...
            UIButton *rightOneBtn = [[UIButton alloc] initWithFrame:CGRectMake(ZYHT_ScreenWidth-leftRightIconWH, ZYHT_StatusBarHeight + iTemp, leftRightIconWH, leftRightIconWH)];
